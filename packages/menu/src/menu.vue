<script type="text/jsx">
  ...
  import Menubar from 'xiaogj-youli-element-ui/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'xiaogj-youli-element-ui/src/utils/dom';
